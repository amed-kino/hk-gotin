...
<main id="main" class="site-main" role="main">
    <section id="property">
        <header class="page-header clearfix">
			...
			<div class="information">
	                    ...
	                    <div class="description"><?php echo __('Albums'); ?> (<?php echo $this->Paginator->counter(array('format'=>'{:count}'));?>)</div>
                            <div class="tips"><span class="text-danger">*</span><?php echo __('%s means if the album is availabe for public view.','<em>Available </em>');?></div>
			</div>
        ...
        <div class="page-body property-body clearfix">
            <div class="property-navigator col-lg-12">
                <?php echo $this->Element('property/navigator',array('section'=>'albums'));?>
                <hr class="clearfix "/>
            </div>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('lyric_counter',__('Lyrics')); ?></th>
                        <th><?php echo $this->Paginator->sort('Artist.name',__('Artist')); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($album['Album']['title'], array('controller' => 'albums', 'action' => 'index', $album['Album']['unique'])); ?> <?php echo $this->HK->albumYear($album['Album']['year']);?>
		</td>
                <td><?php echo h($album['Album']['lyric_counter']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($album['Artist']['name'], array('controller' => 'artists', 'action' => 'index', $album['Artist']['unique'])); ?>
		</td>
		<td><?php echo h($album['Album']['available']); ?>&nbsp;</td>
		<td><?php echo $this->Time->timeAgoInWords($album['Album']['created']);?>&nbsp;</td>
