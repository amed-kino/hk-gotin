...
<div id="driver">
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Lyrics');?></li>
    </ol>
</div>
    ...
    <section id="find">
        <header class="page-header clearfix">
            <div class="main-info">
                ...
                <div class="text-container">
                    <div class="title"><i class="glyphicon glyphicon-lyric"></i> <?php echo __('Search for %s between artists','<em>'.$key.'</em>');?></div>
                        <div class="info">
        ...
        <div class="page-body clearfix">
            ...
            <div id="search-main" class="page-content clearfix">
                <?php if ($lyrics_params['pageCount']!=0&&$lyrics_params['pageCount']!=1):?><p class="search-page-info"><?php echo $this->Paginator->counter(array( 'format' => __('Page {:page} of {:pages}, showing {:current} records out of {:count} total, starting on record {:start}, ending on {:end}')));?></p><?php endif;?>
                <?php if ($isEmtpy == true):?><?php endif;?>
            ...
            if (isset($lyrics) && $lyrics!=NULL){
                ...
                echo '<h5><i class="glyphicon glyphicon-warning-sign"></i> ',__('There is no matched lyrics to %s','<em>'.$key.'</em>'),'</h5>';
            }
            ?>
                <?php if($lyrics_params['pageCount']!=0&&$lyrics_params['pageCount']!=1){echo $this->element('pagination');} ?>
