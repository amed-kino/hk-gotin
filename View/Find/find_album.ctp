<?php
$isEmtpy = false;
if (isset($albums) && $albums!=NULL){$isEmtpy = true;}
...
<div id="driver">
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Albums');?></li>
    </ol>
</div>
    ...
    <section id="find">
        <header class="page-header clearfix">
            <div class="main-info">
                ...
                <div class="text-container">
                    <div class="title"><i class="glyphicon glyphicon-album"></i> <?php echo __('Search for %s between albums','<em>'.$key.'</em>');?></div>
                        <div class="info">
                            <?php echo __('Results (%s)',$albums_params['count']);?><br/>
                        </div>
                </div>
            </div>
        ...
        <div class="page-body clearfix">
            ...
            <div id="search-main" class="page-content clearfix">
                <?php if ($albums_params['pageCount']!=0&&$albums_params['pageCount']!=1):?><p class="search-page-info"><?php echo $this->Paginator->counter(array( 'format' => __('Page {:page} of {:pages}, showing {:current} records out of {:count} total, starting on record {:start}, ending on {:end}')));?></p><?php endif;?>
         <?php if ($isEmtpy == true): ?>
            <div class="results col-lg-12">
                <p><?php echo __('%s albums',$albums_params['count']);?></p>
            </div>
        <?php endif;?>
    <div id="search-item-main-album">
        <?php
        if ($isEmtpy == true){
            ...
            echo '<h5><i class="glyphicon glyphicon-warning-sign"></i> ',__('There is no matched albums to %s','<em>'.$key.'</em>'),'</h5>';
        }
        ?>
     ...
     <?php if($albums_params['pageCount']!=0&&$albums_params['pageCount']!=1){echo $this->element('pagination');} ?>
