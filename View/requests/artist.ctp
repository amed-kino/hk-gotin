...
<main id="main" class="site-main" role="main">
        ...
        <header class="page-header clearfix">
            <div class="main-info">
                ...
                <div class="text-container">
                    <div class="title"><i class="glyphicon glyphicon-artist"> </i> <?php echo __('Request an artist from HK');?></div>
                    <div class="tips">
    ...
    <?php echo $this->Form->create('Request');?>                                      
        ...
        <div class="input-group pull-right col-md-8 col-xs-12 col-md-pull-4 col-xs-pull-0">
